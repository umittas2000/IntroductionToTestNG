...
public class Dependency_WithDependency {
    ...
    @Test(dependsOnMethods = "test2_OpenLoginPage")
    ...
    @Test(dependsOnMethods = "test3_Login")
    ...
    @Test(dependsOnMethods = "test4_VerifyLoginMessage")
    ...
    @Test(dependsOnMethods = "test5_VerifySecureAreaMessage")
